...
SwitchUser.setup do |config|
  ...
  config.available_users_identifiers = { user: :email }
  ...
  config.controller_guard = ->(_current_user, _request) { _current_user && _current_user.is_a?(Users::God) }
  ...
  config.redirect_path = ->(_request, _params) { '/dashboard' }
