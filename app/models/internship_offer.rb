...
class InternshipOffer < ApplicationRecord
  ...
  scope :weekly_framed, lambda {
    where(type: [nil, InternshipOffers::Api.name])
  }
  ...
  validates :street,
              :city,
              presence: true
  validates_presence_of :tutor_name, :unless => Proc.new {|user| user.type == "InternshipOffers::Api"}
  validates_presence_of :tutor_phone, :unless => Proc.new {|user| user.type == "InternshipOffers::Api"}
  validates_presence_of :tutor_email, :unless => Proc.new {|user| user.type == "InternshipOffers::Api"}
