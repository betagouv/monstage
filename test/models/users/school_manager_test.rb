...
module Users
  class SchoolManagerTest < ActiveSupport::TestCase
    ...
    test 'school_manager without school or weeks redirects to account_path' do
    ...
    test 'school_manager with school and weeks redirects to dashboard_school_path' do
