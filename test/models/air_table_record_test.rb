...
class AirTableRecordTest < ActiveSupport::TestCase
  ...
  test 'by_year' do
    ...
    assert_equal 1, AirTableRecord.by_year(school_year: school_years[0]).count
    assert_equal 1, AirTableRecord.by_year(school_year: school_years[1]).count
    assert_equal 1, AirTableRecord.by_year(school_year: school_years[2]).count
  end
