...
class UserUpdateTest < ApplicationSystemTestCase
  ...
  test 'student can update his email' do
    ...
    assert success_message == "Compte mis à jour avec succès. Un email a été envoyé à l'ancienne adresse. Veuillez cliquer sur le lien contenu dans l'email pour confirmer votre nouvelle Adresse électronique (e-mail)."
  end
