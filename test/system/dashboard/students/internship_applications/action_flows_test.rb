    ...
    class AutocompleteSchoolTest < ApplicationSystemTestCase
      ...
      test 'student can browse his internship_applications' do
        ...
        internship_applications = {
          drafted: create(:weekly_internship_application, :drafted,
                          internship_offer: create(:weekly_internship_offer, weeks: school.weeks), student:),
      ...
      test 'student can draft a internship_applications and get former filled in phone number when login is not a phone' do
        travel_to Date.new(2019, 12, 1) do
          ...
          create(:weekly_internship_application, :drafted, student:, student_phone: '0611223344')
          internship_offer = create(:weekly_internship_offer, weeks:)
      ...
      test 'when confirmed an internship_application a student cannot apply a drafted application anymore' do
        ...
        student = create(:student,
                         school:,
                         class_room: create(:class_room, school:))
        internship_offer_1 = create(:weekly_internship_offer, weeks:)
        internship_offer_2 = create(:weekly_internship_offer, weeks:)
      ...
      test 'reasons for rejection are explicit for students when employer rejects internship_application' do
        travel_to Date.new(2019, 10, 1) do
          ...
          student = create(:student,
                           ...
                           class_room: create(:class_room, school:))
          internship_offer = create(:weekly_internship_offer, weeks:,
                                                              internship_offer_area: employer.current_area, employer:)
          internship_application = create(:weekly_internship_application,
                                          :submitted,
                                          internship_offer:,
                                          student:)
