...
module Finders
  class TabEmployerTest < ActiveSupport::TestCase
    test 'pending_agreements_count only agreements' do
      ...
      draft_internship_agreement = create(:internship_agreement, :created_by_system, internship_application: application)
      validated_internship_agreement = create(:internship_agreement, :created_by_system, aasm_state: 'validated', internship_application: application)
