...
module InternshipApplications
  class ShowTest < ActionDispatch::IntegrationTest
    ...
    test 'GET #show renders preview for student owning internship_application' do
      ...
      internship_application = create(:internship_application, :weekly, :drafted, internship_offer: internship_offer)
    ...
    test 'GET #show renders preview for school_manager' do
      ...
      internship_application = create(:internship_application, :weekly, :drafted, internship_offer: internship_offer, student: student)
