...
ActiveRecord::Schema.define(version: 20_190_606_145_310) do
  ...
  create_table 'internship_offers', force: :cascade do |t|
    ...
    t.index %w[max_internship_week_number blocked_weeks_count], name: 'not_blocked_by_weeks_count_index'
