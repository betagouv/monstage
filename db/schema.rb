...
ActiveRecord::Schema.define(version: 20_200_218_163_758) do
  ...
  create_table 'internship_applications', force: :cascade do |t|
    ...
    t.index %w[user_id internship_offer_week_id], name: 'uniq_applications_per_internship_offer_week', unique: true
  ...
  create_table 'internship_offer_weeks', force: :cascade do |t|
    ...
    t.index %w[internship_offer_id week_id], name: 'index_internship_offer_weeks_on_internship_offer_id_and_week_id'
  ...
  create_table 'internship_offers', force: :cascade do |t|
    ...
    t.index %w[internship_offer_weeks_count blocked_weeks_count], name: 'not_blocked_by_weeks_count_index'
  ...
  create_table 'weeks', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[number year], name: 'index_weeks_on_number_and_year', unique: true
