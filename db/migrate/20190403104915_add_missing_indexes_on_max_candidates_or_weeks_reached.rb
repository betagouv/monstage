...
class AddMissingIndexesOnMaxCandidatesOrWeeksReached < ActiveRecord::Migration[5.2]
  # add_index :internship_offers, [:max_internship_week_number, :blocked_weeks_count],
  #                                 name: 'not_blocked_by_weeks_count_index'
  def change
    add_index :internship_offers, %i[max_internship_week_number blocked_weeks_count],
              name: 'not_blocked_by_weeks_count_index'
