...
heroku pg:psql -a $HEROKU_APP_NAME -c 'create extension if not exists pg_trgm schema heroku_ext'
heroku pg:psql -a $HEROKU_APP_NAME -c 'create extension if not exists postgis schema heroku_ext'
heroku pg:psql -a $HEROKU_APP_NAME -c 'create extension if not exists unaccent schema heroku_ext'
